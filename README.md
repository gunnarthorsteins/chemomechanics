...
Acoustics is the science of emitting and detecting mechanical waves, or sound waves, and reconstructing the signal to determine mechanical properties of the media through which the waves propagated.
...
Well, it turns out that it also has applications in battery science and engineering. The principle was first demonstrated in [Hsieh et al](https://pubs.rsc.org/en/content/articlelanding/2015/ee/c5ee00111k), where State-of-Charge (SoC) was shown to be accurately detected. Development has since been continued by various research groups and industry players.

The system 

<figure>
<img src="./static/system_schematic.png" alt="Trulli" style="width:50%">
<figcaption align = "center"><b>System schematic. Two transducers sandwich a battery. A sequence of sinusoidal mechanical waves is transmitted on one end and received on the other.</b></figcaption>
</figure>
...
2) `simulation.m` Simply run this (`F5`) to run the simulation. It does not have to be tweaked, unless one wants to change some lower-level parameters. The core is based on the excellent [k-Wave](http://www.k-wave.org/index.php) toolbox.

Both of these can be run in Voltaiq Analytics Studio. Have fun!

### Current Limitations and Future Work

This package is under active development. At the time of writing some functionality is still somewhat facile, espcially the manner in which layer properties such as stiffness and density depend on SoC: they're assumed to be linearly related to SoC with fixed slopes.
