function sensor_data = customkspaceFirstOrder1D(kgrid, medium, source, sensor, varargin)
...
h5_filename = '/home/gunnar/github/voltaiq-acoustics/simulation.h5';
h5create(h5_filename, '/simulation', [inf 1024], 'Datatype', 'single', 'ChunkSize', [1 1024]);
...
for t_index = index_start:index_step:index_end
    ...
    if flags.plot_sim && (rem(t_index, plot_freq) == 0 || t_index == 1 || t_index == index_end)  
        ...
        % save
        h5write(h5_filename, 'simulation', p_plot)
