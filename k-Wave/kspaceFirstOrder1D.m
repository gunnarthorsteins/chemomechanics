...
h5create(h5_filename, dataset_name, [inf grid_size], 'Chunksize', [1 grid_size]);
...
for t_index = index_start:index_step:index_end
    ...
    if flags.plot_sim && (rem(t_index, plot_freq) == 0 || t_index == 1 || t_index == index_end)  
        ...
        % save
        start = [t_index 1];
        p_h5 = transpose(p_plot);
        count = size(p_h5);
        h5write(h5_filename, dataset_name, p_h5, start, count)
        %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
